...
IMGSZ = 2048
EPOCHS = 60
FREEZE = 0           # nothing frozen: at 1280 the memory is not tight
...
def main() -> None:
    ...
    # mask_ratio=2 at all.
    # exp_031 tested the corrections at 1536 and scored 0.4343, below plain
    # exp_002 at 1280 on fat targets and quarter-resolution supervision, which
    # scored 0.4404. Two readings are confounded there: either the corrections
    # are worth nothing, or 1536 cost more than they gained. 1280 separates them,
    # because it is exp_002's own resolution and the best this project has
    # measured -- 2048 was the worst.
    #
    # At 1280 the memory that defeated every attempt at 2048 is not tight: the
    # loss grid is the same 1.60 native pixels either way, and nothing needs
    # freezing, so the whole network trains.
    attempts = ((1280, 4, 1.60), (1280, 2, 1.60))
